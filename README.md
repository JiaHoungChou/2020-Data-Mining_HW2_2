...
### 3. Use (a) XOR problem (Data Mining 2020 HW2 XOR.py), <br> &nbsp &nbsp(b) a classification data set (Data Mining HW2 IRIS.py & Data Mining 2020 HW2 Fetal Health.py), and <br> &nbsp &nbsp(c) a forecasting data set (Data Miining HW2 Boston Housing.py) from the web to demo your program.
